      ...
      <div className="hero-section h-150 grid md:grid-cols-[60%_40%] dark:bg-black dark:text-white">
        <div className='hero-section-content flex flex-col gap-5 md:p-10 p-8'>
          ...
          <div className="flex gap-5 flex-col md:flex-row">
            <button className="rounded-md text-orange-500 font-bold bg-primary-3 hover:scale-105 transition duration-300 py-4 lg:px-10 px-8" onClick={() => { navigate('/chats') }}>Start Chatting</button>
            <button onClick={() => { navigate('/about') }} className="rounded-md text-orange-500 font-bold bg-gray-1000 hover:scale-105 transition duration-300 py-4 lg:px-10 px-8 border-1 border-primary hover:bg-orange-1000">About Application</button>
          </div>
        </div>
