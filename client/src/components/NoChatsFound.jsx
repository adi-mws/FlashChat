...
export default function NoChatsFound({ setShowSearchUsers }) {
  return (
    <div className='selectChat w-100 h-60 gap-4 px-10 bg-gray-100 dark:bg-gray-900 rounded-lg flex flex-col items-center justify-center'>
      ...
      <button className="dark:text-gray-500 text-sm text-center text-primary underline" onClick={() => {setShowSearchUsers(true)}}>Add People</button>
